...
$quotesErr  = "";
  ...
  if(isset($_POST['characterCreateBtn'])) {
   ...
   if(in_array($photoType, ['image/jpg', 'image/png', 'image/jpeg', 'image/webp'])) {
    ...
    (photo, character_name, age, birthday, status, gender, height_cm, weight_kg, rank, personality, quote, created_at)
    VALUES 
    (:photo,:character_name,:age,:birthday,:status,:gender,:height_cm,:weight_kg,:rank,:personality,:quote,:created_at)
");
...
if($result) {
 echo "<script>sweeetAlert(' created a characters', 'characters')</script>";
}
 ...
 <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3"> 
                ...
                <h6 class="m-0 font-weight-bold text-primary">Character Creation Form</h6>
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                           ...
                           <textarea name="personality" class="form-control"><?php echo $personalityErr ?></textarea>
                        </div>
                        <div class="mb-2">
                            <label for="" class="fw-bold">Quotes</label>
                           <input type="text" name="quotes" class="form-control">
                           <span class="text-danger"><?php echo $quotesErr ?></span>
                        </div>
                        <button type="submit" name="characterCreateBtn" class="btn btn-info btn-sm">Submit</button>
                    </form>
                </div>
            </div>
    </div>
